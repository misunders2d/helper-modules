...
def download_gspread(
    service=connect(scope="gspread"), spreadsheet_id=None, sheet_id=None, header=1
):
...
def create_file(file_bytes, file_name, parent_folder, mimetype=None, service=connect()):
